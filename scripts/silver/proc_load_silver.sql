    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CASE WHEN bdate > GETDATE() THEN NULL
                ELSE bdate
            END AS bdate,
            CASE WHEN UPPER(TRIM(REPLACE(REPLACE(gen, CHAR(13), ''), CHAR(10), ''))) 
        ...
        SELECT 
            REPLACE(cid, '-', '') cid,
            CASE WHEN UPPER(REPLACE(REPLACE(TRIM(cntry), CHAR(13), ''), CHAR(10), '')) = 'DE' THEN 'Germany'
                WHEN UPPER(REPLACE(REPLACE(TRIM(cntry), CHAR(13), ''), CHAR(10), '')) IN ('US', 'USA') THEN 'United States'
                WHEN cntry IS NULL OR REPLACE(REPLACE(TRIM(cntry), CHAR(13), ''), CHAR(10), '') = ''
                    THEN 'n/a'
        ...
        SELECT
            ...
            cat,
            subcat,
            CASE WHEN UPPER(REPLACE(REPLACE(TRIM(maintenance), CHAR(13), ''), CHAR(10), '')) = 'NO' THEN 'No'
